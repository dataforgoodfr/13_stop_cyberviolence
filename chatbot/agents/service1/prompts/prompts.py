...
with open(prompt_folder / "./agent1_system_prompt","r") as f:
    agent1_system_prompt = f.read()

with open(prompt_folder / "ask_for_context_system_prompt","r") as f:
    ask_for_context_system_prompt = f.read()

# ask_for_context_system_prompt = agent1_system_prompt + ask_for_context_system_prompt

with open(prompt_folder / "give_advice_system_prompt","r") as f:
